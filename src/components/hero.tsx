...
type HeroProps = { lang: LocaleSegment; dict: Dictionary["hero"] };
      ...
      <div className="mx-auto flex w-full max-w-[420px] flex-col gap-8 desk:max-w-[1216px] desk:flex-row desk:items-center desk:gap-[33px]">
        ...
        <div className="flex flex-col justify-center gap-6 desk:w-[591px] desk:shrink-0">
          <div className="flex flex-col gap-2 desk:gap-4">
            <h1 className="type-h2-mobile text-black desk:type-h1-desktop">{dict.heading}</h1>
            {/* The two breakpoints ship different body copy in the design. */}
            <p className="type-p-sm text-neutral-500 desk:hidden">{dict.introMobile}</p>
            <p className="hidden type-p-md text-neutral-500 desk:block">{dict.introDesktop}</p>
          </div>

          <div className="flex w-full flex-col gap-4 desk:w-auto desk:flex-row desk:items-center desk:justify-start">
            <CtaButton
              href={localePath(lang, "/get-started?audience=personal")}
              variant="primary"
            ...
            <CtaButton
              href={localePath(lang, "/get-started?audience=business")}
              variant="secondary"
              className="w-full desk:w-auto"
            >
              {dict.forBusiness}
